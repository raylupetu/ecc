...
export default function Create() {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Nouvelle Bannière Hero" />
            ...
            <div className="max-w-5xl mx-auto space-y-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-gray-900 tracking-tight">Nouvelle Bannière Hero</h1>
                        <p className="text-gray-500 font-medium">Ajoutez un nouveau slide à la page d'accueil.</p>
                    </div>
                </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-10">
                                ...
                                <div className="space-y-4">
                                    <Label className="font-bold text-gray-700">Image de fond (Full HD recommandé)</Label>
