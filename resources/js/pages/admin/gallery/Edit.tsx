...
export default function Edit({ gallery }: Props) {
    ...
    const [preview, setPreview] = useState<string | null>(gallery.image);
        ...
        <AuthenticatedLayout>
            ...
            <div className="max-w-4xl mx-auto space-y-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-gray-900 tracking-tight">Modifier L'Image</h1>
                        <p className="text-gray-500 font-medium">Mise à jour de la galerie.</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    <div className="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 p-10 space-y-10">
                        ...
                        <div className="space-y-6">
                            <Label className="font-bold text-gray-700">Image Actuelle</Label>
                            <div className="relative group cursor-pointer aspect-video md:aspect-[21/9] bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center overflow-hidden transition-all group-hover:border-[#D90429]/50">
                                {preview ? (
                                    ...
                                    <>
                                        ...
                                        <span className="text-sm text-gray-400 font-bold uppercase tracking-widest text-center px-4">Changer l'image</span>
                                    </>
                                )}
                                <input
                                    type="file"
