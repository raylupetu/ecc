        ...
        <AuthenticatedLayout>
            ...
            <div className="max-w-4xl mx-auto space-y-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-gray-900 tracking-tight">Nouvelle Activité</h1>
                        <p className="text-gray-500 font-medium">Ajoutez un nouveau service ou activité principale.</p>
                    </div>
                </div>
