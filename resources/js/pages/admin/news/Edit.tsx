...
export default function Edit({ news }: Props) {
    ...
    return (
        <AuthenticatedLayout>
            <Head title={`Modifier ${news.title_fr}`} />
            ...
            <div className="max-w-4xl mx-auto space-y-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-gray-900 tracking-tight">Modifier L'Article</h1>
                        <p className="text-gray-500 font-medium">{news.title_fr}</p>
                    </div>
                </div>
